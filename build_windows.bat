...
.venv-build\Scripts\pyinstaller --noconfirm --windowed --onefile --collect-data sv_ttk --name LatencyChecker latency_viewer.py
.venv-build\Scripts\pyinstaller --noconfirm --onefile --name LatencyLogger latency_logger.py
