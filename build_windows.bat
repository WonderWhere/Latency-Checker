...
.venv-build\Scripts\pyinstaller --noconfirm --windowed --onefile --icon assets\icon.ico --add-data assets;assets --collect-data sv_ttk --hidden-import latency_remote --hidden-import latency_sources --name LatencyChecker latency_viewer.py
