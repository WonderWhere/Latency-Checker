...
.venv-build/bin/pyinstaller --noconfirm --windowed --icon assets/icon.icns --add-data assets:assets --collect-data sv_ttk --hidden-import latency_remote --hidden-import latency_sources --name "Latency Checker" latency_viewer.py
